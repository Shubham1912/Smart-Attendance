...
def function4():
    os.startfile(os.getcwd()+"/firebase1/attendence_files/attendence"+str(datetime.now().date())+'.xls')
...
Button(root,text="Attendance Sheet",font=('times new roman',20),bg="#0D47A1",fg="white",command=function4).grid(row=6,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
